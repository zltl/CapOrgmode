...
function Readability(doc, options) {
    ...
    if (!doc || !doc.documentElement) {
        let ndoc = document.implementation.createDocument ('http://quant67.com', 'html', null);

        ndoc.appendChild(doc);
        doc = ndoc;
        console.log("reada: doc.getElementsByTagName=", doc.getElementsByTagName);
    }
    */
